...
import { 
  FaTree, FaCity, FaStar, FaCar, FaCloud, 
  FaMobileAlt, FaDesktop, FaMoon, FaSun, 
  FaPalette, FaHistory, FaShapes, FaArrowRight,
  FaDownload
} from "react-icons/fa";
...
const CategoriesSection = ({ onCategorySelect }) => {
  ...
  const categories = [
    ...
    { 
      ...
      name: "Abstract", 
      icon: <FaPalette />, 
      description: "Creative patterns, geometric designs, and artistic expressions",
      count: "180+",
  ...
  return (
    <section id="categories" className="py-20 bg-gradient-to-br from-gray-900 via-slate-900 to-gray-950 relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed">
            Discover wallpapers organized by style, device, and theme. 
            Find the perfect background that matches your personality.
          </p>
        </motion.div>
        ...
        >
          <div className="flex items-center justify-between mb-8">
            <h3 className="text-2xl font-bold text-white">Popular Categories</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {popularCategories.map((category) => (
              ...
              >
                ...
                {/* Icon */}
                <div className={`${category.bgColor} w-16 h-16 rounded-2xl text-purple-400 flex items-center justify-center text-2xl mb-4 group-hover:scale-110 transition-transform duration-300`}>
                  {category.icon}
                </div>
        ...
        >
          {categories.map((category) => (
            ...
            >
              ...
              {/* Icon */}
              <div className={`${category.bgColor} w-14 h-14 rounded-xl text-sky-500 flex items-center justify-center text-xl mb-4 group-hover:scale-110 transition-transform duration-300 relative z-10`}>
                {category.icon}
              </div>
        ...
        >
          <div className="bg-gradient-to-r from-purple-500/10 to-pink-600/10 backdrop-blur-lg border border-white/10 rounded-2xl p-8 max-w-2xl mx-auto">
            ...
            <p className="text-gray-300 mb-6">
              Browse our complete collection or use advanced search to find the perfect wallpaper.
            </p>
            <motion.button
